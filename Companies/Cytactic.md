...
sub_sector: "cyber incident response management (CIRM) / breach readiness"
stage: "Seed"
status: "sourcing"
owner:
founded: 2019
hq: "Tel Aviv, Israel"
website: "https://cytactic.com"
linkedin: "https://linkedin.com/company/cytactic"
crunchbase: "https://www.crunchbase.com/organization/cytactic"
pitchbook: "https://pitchbook.com/profiles/company/558446-14"
deck_link:
data_room:
lighthouse_link:
...
> [!info] One-Liner
> Cytactic is an AI-powered cyber incident response management (CIRM) platform — an out-of-band system that turns reactive incident response into proactive breach readiness, generating dynamic response plans from a 200+ attribute taxonomy (MITRE ATT&CK, NIST CSF, FAIR) tailored to a customer's threat actors, tech stack, and business processes. Gartner-named leader in the newly announced CIRM category.

## Thesis Fit

- Defining a Gartner-recognized new category (CIRM) — proactive breach readiness vs. reactive IR
- AI tailwind: attack velocity compressing (vuln→exploit months→minutes) makes pre-built, dynamic response plans urgent
- Deeply credentialed founder (Nimrod Kozlovski — Yale cyber-law PhD, Oxford post-doc, ex-Israeli cyber unit) plus blue-chip seed syndicate (Evolution Equity, Shlomo Kramer)
- Enterprise + IR/MDR-channel GTM (EY, Deloitte, Arctic Wolf) and BFSI customers (Prudential, major banks) align with Fin's enterprise/FinServ base

## Team

| Role | Person | Background |
|---|---|---|
| CEO & Co-Founder | [[Nimrod Kozlovski]] | CEO & Co-Founder since 2022; Yale Law (LLM/JSD), Oxford post-doc, Tel Aviv University LLB; ex-JVP Venture Partner & Labs co-founder; ex-Herzog Partner & Head of Tech Regulation; co-founded PLYmedia and Altal Security; former Israeli cyber unit officer |
...
- Enterprise direct + partnerships with security vendors (Halcyon, SecurityScorecard)
- Monthly "better together" demos with 20–30 CISOs
- Notable CISO advisors: Tim Youngblood (McDonald's), others from SolarWinds, Wells Fargo
- 40 employees: ~30 Tel Aviv (R&D/product), ~10 NYC (sales/marketing)

## Traction

- Revenue: ~$1M (focused on product development until recently, as of 2026-05-26)
- $10M+ pipeline generated in Q1 2026 under new COO/CRO
- Early enterprise customers: Coca-Cola, Prudential, major banks
- Headcount: 52 per Harmonic (as of 2026-05-26)

## Financing

| Date | Round | Amount | Investors |
|---|---|---|---|
| 2024-07 | Seed | $16–16.5M | Evolution Equity Partners (lead), Hyperwise Ventures, Shlomo Kramer (Check Point founder) |
| 2026 | SAFE | $4M closed (20% discount, $100M cap); approved up to $7M total | Stripe executive |

- Recently closed $4M SAFE (20% discount, $100M cap) from a Stripe executive; approved to raise up to $7M total in the SAFE round (as of 2026-05-26)
- Planning a substantial Series A in Q4 2026 based on revenue growth; Evolution Equity committed to pro-rata participation
- Delaware incorporated with Israeli parent; considering US vs. international investment pools
...
- [ ] Confirm Bill Hogan title (CRO vs COO) and exact seed/SAFE cap-table structure
