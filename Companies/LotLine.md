---
type: company
sector: PropTech / Real Estate Tax
sub_sector: AI-Native Cost Segregation
stage: Pre-Seed
status: sourcing
owner:
founded: 2025
hq: San Francisco, CA
website: https://trylotline.com
linkedin: https://linkedin.com/company/lotline
crunchbase:
pitchbook: https://pitchbook.com/profiles/company/770265-10
deck_link:
data_room:
lighthouse_link:
...
> [!summary] One-Liner
> Real estate tax intelligence platform for investment funds — entering via AI-native cost segregation services, with long-term vision to model tax outcomes down to the LP level.
...
- **Problem:** Real estate tax analysis (especially cost segregation) is expensive, slow, and manual — traditional consultants charge $10–20K per study with long turnarounds; hard to scale across investment fund portfolios.
- **Product:** AI-native cost segregation platform. Classifies building components by depreciation schedule (e.g., carpet = 5yr, tile = 39yr) to accelerate tax benefits. Bonus depreciation allows 100% year-one write-off for <20yr components.
  - 80% automated as of April 2026 (up from 20% in December 2025)
  - Target: 100% automation on residential properties
  - Long-term vision: Model tax outcomes down to LP level for investment decisions
- **Wedge / entry point:** Sub-$5K AI-powered cost seg studies (vs $10–20K traditional consultants). Direct sales to investment funds with 10–20 property acquisitions/year.
...
2. CPA partnerships via co-branding/white-labeling
3. Digital partnerships through proptech tools for long-tail market
...
- One check already from Forum Ventures
- First planned hire: Internal ops/project management with construction background
- [[Jake Fuchs]] to consult with Jackson at MetaProp for market insights
- [[Derek Wu]] to follow up separately with building address for cost segregation opportunity
- Fin team to circle back early-mid next week with investment decision
